...
My only regret about iObjects is not have understanding [Silvio Meira](https://twitter.com/srlm)'s advice to make it open source. While I'm writing these lines, I can see before my eyes the names of great current frameworks and I can't stop wondering: what if I had done that?
