...
function PopupWindow_getXYPosition(anchorname) {
  ...
  var oTop  = o.offsetTop + o.offsetHeight;
  ...
  if ((oLeft + this.width) > document.body.clientWidth)
    oLeft = document.body.clientWidth - this.width;
  if ((oTop + this.height) > document.body.clientHeight)
    oTop = document.body.clientHeight - this.height;
  this.x = oLeft;
  this.y = oTop;
}
...
function CP_tmpReturnFunction(y,m,d) {
    ...
    window.CP_targetInput.style.color = "#0000ff";
		}
	else {
...
function getCalendarStyles() {
	...
	result += "<STYLE>\n";
	result += "."+p+"cpYearNavigation,."+p+"cpMonthNavigation { background-color:#FFF35A; text-align:center; vertical-align:middle; text-decoration:none; color:#29459C; font-weight:bold; }\n";
